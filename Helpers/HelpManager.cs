...
namespace Endurance_Testing.Helpers
{
    public static class HelpManager
    {
        public static string GenerateHelpMessage()
        {
            ...
            helpMessage.AppendLine("7. Click the 'Start' button to initiate the endurance test.");
            helpMessage.AppendLine("8. Monitor the test results in the 'Output:' text area below the input fields and the remaining time above the output area.");
            helpMessage.AppendLine("9. Upon test completion, the 'Output:' area will display:");
            ...
            helpMessage.AppendLine("10. Click the 'Clear' button to reset the input fields and the output area.");
            helpMessage.AppendLine("11. Click the 'Export' button to save test results in various formats:");
